...
const ChartContainer = /*#__PURE__*/ React.forwardRef(({ id, className, children, config, ...props }, ref)=>{
...
const ChartTooltipContent = /*#__PURE__*/ React.forwardRef(({ active, payload, className, indicator = "dot", hideLabel = false, hideIndicator = false, label, labelFormatter, labelClassName, formatter, color, nameKey, labelKey }, ref)=>{
...
const ChartLegendContent = /*#__PURE__*/ React.forwardRef(({ className, hideIcon = false, payload, verticalAlign = "bottom", nameKey }, ref)=>{
    const { config } = useChart();
    if (!payload?.length) {
        return null;
    }
